      ...
      try
      {
        ...
        try
        {
          ...
          try
          {
            ...
            // Check version...
            string version = libvlc_get_version();
            if(version == null)
            ...
            m_libvlc_toggle_fullscreen = (libvlc_toggle_fullscreen_signature)LoadDelegate<libvlc_toggle_fullscreen_signature>("libvlc_toggle_fullscreen");
            m_libvlc_set_fullscreen = (libvlc_set_fullscreen_signature)LoadDelegate<libvlc_set_fullscreen_signature>("libvlc_set_fullscreen");
            m_libvlc_get_fullscreen = (libvlc_get_fullscreen_signature)LoadDelegate <libvlc_get_fullscreen_signature>("libvlc_get_fullscreen");
