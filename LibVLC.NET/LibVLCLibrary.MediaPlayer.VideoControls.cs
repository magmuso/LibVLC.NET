...
//
//    Copyright (C) 2016 Martynas Melninkas
...
namespace LibVLC.NET
{
  ...
  partial class LibVLCLibrary
  {
    ...
    private delegate void libvlc_toggle_fullscreen_signature(IntPtr p_mi);

    //==========================================================================
    private readonly libvlc_toggle_fullscreen_signature m_libvlc_toggle_fullscreen;

    //==========================================================================
    public void libvlc_toggle_fullscreen(IntPtr p_mi)
    {
        VerifyAccess();
        m_libvlc_toggle_fullscreen(p_mi);
        return;
    }
    ...
    //==========================================================================
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void libvlc_set_fullscreen_signature(IntPtr p_mi, int b_fullscreen);

    //==========================================================================
    private readonly libvlc_set_fullscreen_signature m_libvlc_set_fullscreen;

    //==========================================================================
    public void libvlc_set_fullscreen(IntPtr p_mi, int b_fullscreen)
    {
        VerifyAccess();
        m_libvlc_set_fullscreen(p_mi, b_fullscreen);
        return;
    }
    ...
    //==========================================================================
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate int libvlc_get_fullscreen_signature(IntPtr p_mi);

    //==========================================================================
    private readonly libvlc_get_fullscreen_signature m_libvlc_get_fullscreen;

    //==========================================================================
    public int libvlc_get_fullscreen(IntPtr p_mi)
    {
        VerifyAccess();
        int val = m_libvlc_get_fullscreen(p_mi);
        return val;
    }
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate int libvlc_video_take_snapshot_signature(IntPtr p_mi, uint num, char[] psz_filepath, uint i_width, uint i_height);

    //==========================================================================
    private readonly libvlc_video_take_snapshot_signature m_libvlc_video_take_snapshot;

    //==========================================================================
    public int libvlc_video_take_snapshot(IntPtr p_mi, uint num, string psz_filepath, uint width, uint height)
    {
        VerifyAccess();

        char[] chars = new char[psz_filepath.Length];

        chars = psz_filepath.ToCharArray();

        int val = m_libvlc_video_take_snapshot(p_mi, num, chars, width, height);
